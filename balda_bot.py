...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        "🤖 *О проекте «Балда»*\n\n"
        "Балда — это цифровой помощник для пассивного заработка\n\n"
        "📌 *Как это работает:*\n"
        "1. Ты регистрируешься в партнерке Яндекса\n"
        "2. Создаем новый профиль в инстаграм\n"
        "3. Ты выкладываешь фото/видео по инструкции\n\n"
        "4. Курьеры регаются по твоей ссылке\n"
        "5. Ты получаешь деньги за каждый заказ, который делает твой курьер!!!\n"
        "💡 *Концепция:*\n"
