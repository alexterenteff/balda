...
async def more(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "Ты под моим руководством откроешь партнерский кабинет, получишь реф.ссылку, создашь новый профиль в инстаграм и зальешь первые 10 рилсов по моим промптам.\n\n"
        "Со временем, всю эту работы буду делать я, а ты только деньги получать\n\n"
    )
...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        "Пока Балда будет говорить, что тебе делать по шагам, чтобы ты прошел весь путь на первом примере "Заработок на Курьерах", но потом Балда будет выполнять 80% всех задач, а ты только получть пассивный доход"
